...
def makeFig(): #create a function that makes our desired plot
    plt.xlim(-10+X_offset,20+X_offset)
    plt.ylim(-20+Y_offset,10+Y_offset) #set y min and max values
    ...
    plt.text(9.5+X_offset,9.25+Y_offset,level,color='red',fontsize=12)
    plt.text(6+X_offset,7.5+Y_offset,'P=',color='blue',fontsize=12)
    plt.text(8.5+X_offset,7.5+Y_offset,pressure,color='blue',fontsize=12)
    plt.text(6+X_offset,5.75+Y_offset,'STEPs=',color='orange',fontsize=12)
    plt.text(9.5+X_offset,5.75+Y_offset,STEP,color='orange',fontsize=12)
    plt.text(6+X_offset,3+Y_offset,'D(Line)=',color='purple',fontsize=12)
    plt.text(9.5+X_offset,3+Y_offset,distance0,color='Purple',fontsize=12)
    plt.text(6+X_offset,1.25+Y_offset,'D(Walk)=',color='Green',fontsize=12)
    plt.text(9.5+X_offset,1.25+Y_offset,distance1,color='Green',fontsize=12)
    plt.text(6+X_offset,-0.5 + Y_offset,'Altitude=',color='grey',fontsize=12)
    plt.text(9.5+X_offset,-0.5 +Y_offset,altitude,color='grey',fontsize=12)
##    plt.text(6+X_offset,9.25+Y_offset,'LEVEL=',color='red',fontsize=12)
